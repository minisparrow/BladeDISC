...
// TEST(EmbeddingColumnTest, StaticShape3DI64Test) {
//   std::vector<float> input_val;
//   for (int i = 0; i < 1000; i++) {
//     input_val.push_back(static_cast<float>(static_cast<int64_t>(i % 10)));
//   }
//   EXPECT_TRUE(feature_test_main(
//       /*mlir_file_path*/ c_ft_path + "embedding_column_s_3d_i64.mlir",
//       /*backend_types*/ {kSupportedCPUBackendList},
//       /*num_inputs*/ 1,
//       /*num_outputs*/ 1,
//       /*input_descriptors*/ {"10x10x10xi64_X"},
